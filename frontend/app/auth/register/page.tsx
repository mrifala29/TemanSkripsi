  ...
  return (
    <div className="relative min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8 md:py-12">
      ...
      >
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-2 text-center">Buat akun baru</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          <div>
            <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1 md:mb-1.5">Nama Lengkap</label>
            <input
              type="text"
              value={name}
