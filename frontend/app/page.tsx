    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-white pt-12 pb-28 px-6 min-h-[88vh] flex items-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
          ...
          >
            Platform AI untuk persiapan sidang skripsi mahasiswa Indonesia. Latihan tanya-jawab dengan AI dosen penguji kritis, analisa mendalam skripsimu, dan uji kesamaan teks — semua dalam satu tempat.
          </motion.p>
          {/* SEO keyword stats */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            {[
              ...
              { num: '~50', label: 'Template pertanyaan' },
            ].map((stat, i) => (
